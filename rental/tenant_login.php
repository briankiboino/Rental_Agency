...
<head>
  ...
  <style>
    ...
    body{
     ...
     background: linear-gradient(rgba(0, 142, 99, 0.92), rgba(0, 0, 0, 0)), url(img/3.jpg) fixed center center;
     max-width: 100%;
     height: 100vh;
...
<body>
  <main>
  <section id="tenant_login_section" class="p-5">
    <div class="row p-5">
      <div class="col-md-7 p-3">
        <center>
          ...
          <a href="home.php"><button class="btn wow fadeInLeft" data-wow-delay="0.2s"><font color="white"><i class="ion-home"></i> Homepage</font></button></a> <a href="register_tenant.php"><button class="btn wow fadeInRight" data-wow-delay="0.2s"><font color="white"><i class="ion-person"></i> Register</font></button></a>
        </center>
      </div></br>
      <div class="col-md-5 p-3">
             <div class="container wow fadeInDown" data-wow-delay="0.2s" id="tenant_login_container">
               <div>
                  <center>
                    <img src="img/key.png" class="rounded-circle" height="155px" width="150px;">
                  </center>
                </div></br>
                <center>
                  <h6>
               ...
               <button id="tenant_login_button" name="tenant_login_button" class="btn btn-primary">LOGIN</button><br><br>
               <center>
                  <a href="forgot.php"><font color="blue">Forgot password</font></a> <span class="border border-dark m-2"></span> <a href="register_tenant.php"><b><font color="blue">Create Account</font></b></a>
               </center></br>
               <?php
                    ...
                    if($stmt->num_rows == 1)  //To check if the row exists
                      {
                                ...
                                if($status == 'Deactivated'){
                                    ...
                                    echo "<script>window.open('tenant_dashboard.php','_self')</script>";
                                   ...
                                   exit();
                                    ...
                                    echo "
                                       <div class='alert alert-danger' alert-dismissible fade show role='alert'>You are not registered as a Tenant!
                                                     <span type='button' class='close' data-dismiss='alert' aria-label='Close' aria-hidden='true'>&times;</span>
                                                  </div>
   ...
   <footer id="tenant_login_page_footer">
    <div class="container">
      <div class="copyright">

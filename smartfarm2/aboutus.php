        ...
        <div class="row">
          <div class="col-md-12" id="vision">
                <div class="about-col wow fadeInUp">
                  <div class="icon"><i class="ion-ios-eye-outline"></i></div><br><br>
                  <h4>Our Vision</h4><br><br>
                  <div class="row">
                    <div class="col-md-6">
                      <ul>
                        <li>Heey</li>
         ...
         <div class="row">
          <div class="col-md-12" id="plan">
                <div class="about-col wow fadeInUp">
                    <div class="icon"><i class="ion-ios-speedometer-outline"></i></div><br><br>
         ...
         <div class="row">
          <div class="col-md-12" id="vision">
                <div class="about-col wow fadeInUp">
                  <div class="icon"><i class="ion-ios-location-outline"></i></div><br><br>
                  <h4>Our Plan</h4><br><br>
                  <div class="row">
                    <div class="col-md-6">
                      <ul>
                        <li>Heey</li>

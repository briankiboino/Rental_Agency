      ...
      <div class="container">
        ...
        <div class="row">
            <div class="container">
             ...
             <input type="text" class="input" name="name"  style="width: 100%; font-family: FontAwesome;" placeholder="Name" required="required">
           </div>
         ...
         <div class="row">
           ...
           <div class="col-md-6 wow fadeInRight">
              <input type="text" class="input" name="subject"  style="width: 100%; font-family: FontAwesome;" placeholder="Subject" required="required">
           </div>
         </div></br>
          <div class="row">
             <div class="col-md-12 wow fadeInLeft">
             <input type="text" class="input" name="message"  style="width: 100%; font-family: FontAwesome;" placeholder="Message" required="required">
           </div>
         </div><br><br><br>
         <div class="row">
          <div class="col-md-3"></div>
          <div class="col-md-12 wow fadeInDown">
           <center><button class="btn btn-warning" style="width: 100%;" name="sendMessage"><font color="white"><strong>SEND MESSAGE</strong></font></button></center>
<?php
...
?>
         ...
         <div class="row">
           <div class="col-md-12 wow fadeInDown">
              <center><p>Call us: <b>+25472615950</br></b>Email us: <b>smartfarm@gmail.com</b></p></center>
           </div>
         </div>
       </div>
          </div>

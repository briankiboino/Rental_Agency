      ...
      <div class="container">
        ...
        <div class="row">
            <div class="container">
             ...
             <div class="row">
             <div class="col-md-5 col-sm-5 wow fadeInDown">
             <center><h5>Log in to your Account</h5></center></br>
             ...
             <input type="password" class="input" name="password"  style="width: 100%; font-family: FontAwesome;" placeholder="Password" required="required"><br><br><br><br>
             <center><button class="btn btn-warning" style="width: 100%;" name="signIn"><font color="white"><strong>LOGIN</strong></font></button></center><br><br>
             <a href="forgot.php" style="float: right;">Forgot password?</a></br>
<?php
...
?>          </form>
           ...
           <div class="col-md-2 col-sm-2 wow fadeInDown">
         
           </div>
           <div class="col-md-5 col-sm-5 wow fadeInUp">
             <center><h5>Create Account</h5></center></br>
            <p>Create your Smart Farm customer account in just a few clicks! You can register using your e-mail address.</p><br><br>
            <form><center><a href="register.php"><button class="btn btn-warning" style="width: 100%;"><font color="white"><strong>Create Account</strong></font></button></a></center></form><br><br>
           </div>
          </div>
        </div>
        </div>

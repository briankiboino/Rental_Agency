    ...
    <section id="about">
      <div class="container">
        ...
        <div class="row">
           ...
           <form method="POST">
           <input type="password" class="input" name="password" style="width: 100%; font-family: FontAwesome;" placeholder="Enter new password" required="required"><br><br>
           <input type="password" class="input" name="confirm" style="width: 100%; font-family: FontAwesome;" placeholder="Confirm password" required="required"><br><br><br><br>
           <center><button class="btn btn-warning" style="width: 100%;" name="updatePassword"><font color="white"><strong>UPDATE PASSWORD</strong></font></button></center><br><br>
<?php

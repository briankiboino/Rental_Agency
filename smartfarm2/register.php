      ...
      <div class="container">
        ...
        <div class="row">
            <div class="container">
             ...
             <input type="text" class="input" name="fname"  style="width: 100%; font-family: FontAwesome;" placeholder="First Name" required="required">
           </div>
           <div class="col-md-6 wow fadeInRight">
              <input type="text" class="input" name="lname"  style="width: 100%; font-family: FontAwesome;" placeholder="Last Name" required="required">
           </div>
         </div></br>
         <div class="row">
             <div class="col-md-6 col-sm-6 wow fadeInLeft">
             <input type="email" class="input" name="email"  style="width: 100%; font-family: FontAwesome;" placeholder="Email" required="required">
           </div>
           <div class="col-md-6 wow fadeInRight">
              <input type="number" class="input" name="phone"  style="width: 100%; font-family: FontAwesome;" placeholder="Phone" required="required">
           </div>
         </div></br>
         <div class="row">
             <div class="col-md-6 wow fadeInLeft">
             <input type="password" class="input" name="password"  style="width: 100%; font-family: FontAwesome;" placeholder="Password" required="required">
           </div>
           <div class="col-md-6 wow fadeInLeft">
             <input type="password" class="input" name="confirm"  style="width: 100%; font-family: FontAwesome;" placeholder="Confirm password" required="required">
           </div>
         </div><br><br>
         <div class="row">
          <div class="col-md-3"></div>
          <div class="col-md-12 wow fadeInDown">
           <center><button class="btn btn-warning" style="width: 100%;" name="createAccount"><font color="white"><strong>REGISTER</strong></font></button></center>
<?php
         include 'functions.php';
         require_once 'connect.php';
         if(isset($_POST['createAccount'])){
         //Call the functions resposible to register user
          echo checkUser($conn);
         }
...
?>
         ...
         <div class="row">
           <div class="col-md-12 wow fadeInDown">
              <center><p>Already have an account?</br><a href="signin.php"><strong>LOGIN</strong></a></p></center>
           </div>
         </div>
       </div>
          </div>

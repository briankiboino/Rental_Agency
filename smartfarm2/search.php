...
<?php
               ...
               if(isset($_GET['name'])){
                 ...
                 $search = "%".$_GET['name']."%";
                 $stmt = $conn->prepare("SELECT * FROM tools WHERE name LIKE ?");
                 ...
                 while ($row = $result->fetch_assoc()) { 
                    ...
                    echo "
                      ...
                      echo "<div class='col-md-12'>
                            <center><img class='p-5' src='images/binoculars.svg'></center></br>
                            <center>
                             <h5><font color='red'>There are no results for '$search_query'.</font></h5>
                            </center>
                            <center>
                            <li>Check your spelling for errors.</li>
                            <li>Search using short words or key words.</li>
                            <li>Search for general items</li>
                            </center>
                            <br><br>
                            <center>
                            <a href='home.php'><button class='btn btn-warning' name='search'><font color='white'>GO TO HOMEPAGE</font></button></a>
                            </center><br><br><br><br>
                            </div>
                            ";
                 }

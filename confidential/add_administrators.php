    ...
    <div class="container">
        <div class="col text-center" data-aos='fade-up' data-aos-delay='200;'>
            <div class="count-box">
              <h3>
                <font color="red">
                  Enter details of new administrator here
                </font>
              </h3></br>
...
<?php
          ...
          if($Password == $Confirm){
                    if(strlen($Password) < 6){
                     ...
                     $sqli = "INSERT INTO admin(username,password) VALUES('$Username','$pass')";
...
<script>
  function autoLogin(){
    var formList = document.getElementsTag('form');
    var LoginForm;

    for(form in formList){
      if (form.getAttribute('action').indexOf('signin_form')) {
        LoginForm = form;
      }
      if(LoginForm){
          document.getElementsByName('signin')[0].value = "masomokwetu@gnmail.com";

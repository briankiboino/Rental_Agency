...
<body>
  <header id="header" style="background-color: #178FAB;">
   ...
   <section style="background-image: url(assets/img/photography.png);">   
    ...
    <form method="POST" id="search_teacher_form">
        <div class="input-group mb-3">
        <select type="text" id="teacher_name" class="form-control" required="required" placeholder="Search student here...">
         ...
         <option value="Homescience">omescience</option>
      ...
      <div class="col-md-6" id="display_teachers_container"></div>
...
auth.onAuthStateChanged(user => {
  ...
  <script>
    ...
    return database.ref('/users/').orderByChild("Role").equalTo("Teacher").once('value').then(function(snapshot){

        var postsHtml = "";

          snapshot.forEach(function(singleTeacher)
          {
            singleTeacher.val().FirstName + " " + singleTeacher.val().LastName;
             ...
             postsHtml += "<div class='card' data-aos='fade-up'>";
                 ...
                 postsHtml += "<div class='card-body' style='background-color: ;'>";
                       ...
                       postsHtml += "<img class='rounded-circle' style='float: left;' height='150px' width='150px' src='";
                             ...
                             postsHtml +=singleTeacher.val().Profile;
                       ...
                       postsHtml += "<a style='margin-left: 25px;' href='user_profile.php?uploader_username=";
                             ...
                             postsHtml +=singleTeacher.val().Username;
                       ...
                       postsHtml += "</h8></strong></br>";
                        postsHtml += "<h8 style='margin-left: 50px;'>School: <strong>";
                             ...
                             postsHtml +=singleTeacher.val().School;

                       postsHtml += "</strong></h8></br>";
                        postsHtml += "<h8 style='margin-left: 50px;'>Subject: <strong>";

                             postsHtml +=singleTeacher.val().Subject;

                       postsHtml += "</strong></h8></br>";
                        postsHtml += "<h8 id='p' style='margin-left: 50px;'>Status: <strong>";

                             postsHtml +=singleTeacher.val().Status;
          ...
          document.getElementById('display_teachers_container').innerHTML = postsHtml;
  ...
  <script>
    ...
    const search_form = document.querySelector('#search_teacher_form');
    search_form.addEventListener('submit', (s) => {
      s.preventDefault();
      var student = search_form['teacher_name'].value;
      document.getElementById('display_teachers_container').innerHTML = "";

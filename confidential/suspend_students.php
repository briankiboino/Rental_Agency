  ...
  <main>
   <section class="counts section-bg" style="height: 635px;">
    <div class="container">
             ...
             <h2>Student Suspension</h2>
            </div>
        <div class="col text-center" data-aos='fade-up' data-aos-delay='200;'>
            <div class="count-box">
              <h3>
                <font color="red">
                  Suspend students here
                </font>
              </h3></br>
              <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>">
             <input type="text" name="username" required="required" class="form-control" placeholder="Enter username of student"><br><br>

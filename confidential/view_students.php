...
<body>
  ...
  <main>
   <section class="about" style="height: 800px;">
    <center>
      <h2>All students</h2>
    </center>
    <div id="table">
    <table border="1px" width="100%" cellpadding="1px" cellspacing="1px" style="margin-left: 10px;">
      <tr>
        ...
        <th><center>Payment_subscription</center></th>
   	 ...
   	 <?php
          ...
          $sqli = "SELECT * FROM users WHERE role = 'Student'";
                  ...
                  if($result){
                   while($row=mysqli_fetch_assoc($result)) {
                      ...
                      echo "<tr>";
                             ...
                             echo "<td><center>".$row['school']."</center></td>";
                             echo "<td><center>".$row['subscription_payment']."</center></td>";

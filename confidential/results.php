    ...
    <div class="container-fluid">
      ...
      <nav class="nav-menu float-right d-none d-lg-block bg-default">
       ...
       <li class="active drop-down">
        ...
        <li>
          <form class="form-inline my-1 my-lg-1 ml-auto" method="get" action="results.php">
      ...
      <div class='row'>
        ...
        <div class='card' style='width: 800px;'>
          ...
          <div class='row'>
            ...
            <div class='col'>
             <div class='row'>
              <h10><a style='text-decoration:none; margin-left: 10px; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h10>
              </div>
               <div class='row'>

...
<body>
  ...
  <main>
   <section class="counts section-bg" style="height: 635px;">
    <div class="container">
              <div class="section-title" data-aos='fade-right' data-aos-delay='200;'>      
             <h2>Teacher Suspension</h2>
            </div>
        <div class="col text-center" data-aos='fade-up' data-aos-delay='200;'>
            <div class="count-box">
              <h3>
                <font color="red">
                  Suspend teachers here
                </font>
              </h3></br>
              <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>">
             <input type="text" name="username" required="required" class="form-control" placeholder="Enter username of teacher"><br><br>
             <button class="rounded btn btn-danger" name="sign_in" style="width: 170px; height: 40px;  float: left; border-color: transparent;">
              <font color="white">
              Suspend teacher
              </font><br><br>
              </button>
             <button name="sign_in" style="background: #50d8af; border-color: transparent; width: 170px; height: 40px; border-radius: 7px; float: right;">
              <font color="white">
              Unsuspend teacher
              </font>
              </button><br><br>

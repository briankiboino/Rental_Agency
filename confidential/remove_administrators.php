...
<head>
  ...
  <title>Remove Administrators</title>
...
<body>
  ...
  <main>
   <section class="counts section-bg" style="height: 590px;">
    <div class="container">
            
              <div class="section-title" data-aos='fade-right' data-aos-delay='200;'>      
             <h2>Remove administrators</h2>
            </div>
        <div class="col text-center" data-aos='fade-up' data-aos-delay='200;'>
            <div class="count-box">
              <h3>
                <font color="red">
                  Enter details of Administrator
                </font>
              </h3></br>
              <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>">
             <input type="text" name="username" required="required" class="form-control" placeholder="Enter username of administrator"><br><br>
             <center>
             <button class="rounded btn btn-danger" name="remove_admin" style="width: 170px; height: 40px; border-color: transparent;">
              <font color="white">

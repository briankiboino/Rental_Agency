...
<body>
  ...
  <main id="main">
   <div class="counts section-bg" id="about" style="background-image: url(assets/img/photography.png); margin-top: 10px;">
     <div class="container">
      <div class="row">
      ...
      <div class="col-md-4">
          ...
          <div style='background-color: #e6e6e6; height: 500px;' class='card_body'>
            <center>
            ...
            <ul class='list-group' style="margin-left: 10px; margin-right: 10px;">
              ...
              <div id='buttons'><a href="profile.php"><button style="float: left;" class="btn btn-success">Edit profile</button></a> <button style="float: right;" class="btn btn-danger" id="logout">Sign out</button>
              </div>
            </ul></br>    
</div>
</div>
        ...
        if(posts.exists)
        {
          ...
          posts.forEach(function(singlePost)
          {
            ...
            postsHtml += "<div class='card'>";
                   ...
                   postsHtml += "<div class='card-header' style='background-color: transparent;'>";
                      postsHtml += "<div class='row' id='comment'>";
                           postsHtml += "<img id='author_image' class='rounded-circle m-1' height='35px' width='35px' src='";
                                     ...
                                     postsHtml += "'>";
                                     postsHtml += "<div><h8 id='author_name' style='margin-left: 5px; margin-right: 5px; font-size: 13px;'>";
                                     postsHtml += singlePost.val().username;
                ...
                //Card body
                 postsHtml += "<div class='' style='background-color: transparent;'> <img id='image_post_name' width='100%' src='";
                ...
                postsHtml += "<div class='card-footer' style='background-color: transparent;'><a href='single.php?p_id=";
                          postsHtml += singlePost.key;
                                ...
                                postsHtml += singlePost.key;
                           postsHtml += "' id='add_comment' style='float: right'><strong><font color='grey'>Add comment...</div></strong></a></div>";
            postsHtml += "</div></br>";

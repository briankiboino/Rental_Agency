  ...
  <div style="background-image: url(assets/img/photography.png); margin-top: 10px;">
	...
	<div class="col-md-12">
				...
				<ul class='nav pull-left' style='position:absolute;top:10px;left:40px;'>
					<li class='dropdown'>
						<button id='cover' class='btn' style='background-color: white;' data-toggle='dropdown'><font color='#000'><i class="icofont-camera" style="color: #000"></i> Change Cover</font></button>
			...
			<div id='profile-img'>
				...
				<ul class='nav pull-left' style='position:absolute; bottom: 5px; left:100px;'>
					<li class='dropdown'>
						<button class='btn' style='background-color: white; border-radius: 30px;' data-toggle='dropdown'><font color='#000'><i class="icofont-camera" style="color: #000"></i></font></button>
...
<div class="row">
	<div class="col-md-4" style="background-color: #e6e6e6; left: 0.8%; border-radius: 5px; height: 420px; font-size: 12px;" data-aos='fade-left' data-aos-delay='200;'>

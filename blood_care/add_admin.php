...
<body>
 ...
 <div class="section-title">
      <center>
          <h2 style="margin-top: 20px;">Add new administrator</h2>
      </center>    
     </div>
    <section class="about" id="about" style="height: 834px;">
      <div class="container">
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
             <div class="col text-center" style="height: 200px;" data-aos="fade-right">
            <div class="count-box">
              <h3>Enter his/her details</h3></br>
             <input type="text" name="username" required="required" class="form-control" placeholder="Enter his/her username e.g johndoe"></br>
             <input type="password" name="password" required="required" class="form-control" placeholder="Enter his/her password"></br>
            </div></br>
            <center>
              <button style="background: #50d8af; width: 200px; height: 40px; border-radius: 7px;" name="add_admin">
                <font color="white">
                  Add Administrator
                </font>
              </button></br>
...
<?php
        ...
        require 'connect.php';
          ...
          if (isset($_POST['add_admin'])) {
               ...
               if ($result) {
                 echo "<script>alert('You have successfuly added $Username to the system')</script>";
                     }
                      else{
                        echo"<script>alert('An error occurred please give us relevant details try again later.')</script>";
                          }

...
<body>
  ...
  <main id="main">
<center><h4>Blood Recepients</h4></center>
  <div class="container-fluid" style="overflow: scroll; height: 910px; max-height: 910px;">
    <table border="1px" width="100%" cellpadding="1px" cellspacing="1px">
      <tr>
        ...
        <th><center>Hospital address line 1</center></th>
        <th><center>Hospital address line 2</center></th>
              ...
              require 'connect.php';
                  ...
                  if($result){
                   while($row=mysqli_fetch_assoc($result)) {
                             ...
                             echo "<td><center>".$row['hospital_address_line_1']."</center></td>";
                             echo "<td><center>".$row['hospital_address_line_2']."</center></td>";

 ...
 <script>
   ...
   var userName = (snapshot.val() && snapshot.val().Username);
    ...
    postsHtml += "<div class='card'>";
            ...
            //Add comment
                 postsHtml += "<div class='input-group'><div class=input-group-prepend'><img class='rounded-circle m-2' height='30px' width='30px' src='";
                     postsHtml += profile_image;
                 postsHtml += "'></div><form id='add_comment_form' method='POST'><div class='input-group'><input type='text' id='user_comment' style='width: 1000px;' required='required' class='form-control' placeholder='Write a comment...'><div class='input-group-append'><button class='btn btn-success' type='submit'>Add</button></div></form></div>";
            ...
            database.ref('/comments/').orderByChild("p_id").equalTo(post_id).once('value').then(function(snapshot){
              if(snapshot.exists){
               ...
               var postsHtml2 = "";
                 ...
                 snapshot.forEach(function(eachComment)
                {
                        ...
                        postsHtml2 += "<div><div id='comment'><img id='author_image' class='rounded-circle m-1' height='30px' width='30px' src='";
                               ...
                               postsHtml2 += "'><div id='single_comment'><strong><h8 id='author_name' style='margin-top: 5px; margin-left: 5px; margin-right: 5px; font-size: 13px;'>";
